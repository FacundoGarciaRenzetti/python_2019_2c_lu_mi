...
║   matrices derivadas, como matrices enmascaradas o matrices multidimensionales   ║
║   enmascaradas.                                                                  ║
║   El módulo NumPy proporciona un objeto ndarray que podemos usar para realizar   ║
║   operaciones en una arreglo de cualquier dimensión. El ndarray significa arreglo║
║   de N dimensiones donde N es cualquier número. Los arreglos NumPy puede ser de  ║
║   cualquier dimensión.                                                           ║
