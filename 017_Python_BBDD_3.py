...
#	try:
	...
	puntero.execute(columnas_mysql, ("Primer Apellido Segundo Apellido", "Ariel" , "ariel.Primer Apellido.Segundo Apellido@gmail.com","+5491144754637","45","M",hoy,nacimiento,ingreso))
	conectarse.commit()
	puntero.execute(columnas_mysql, ("Primer Apellido T", "Marisol" , "marisol@gmarisolmail.com","+5491144754637","43","F",hoy,nacimiento,ingreso))
	conectarse.commit()
	puntero.execute(columnas_mysql, ("Primer Apellido T", "Ariel" , "ariel.Primer Apellido.Segundo Apellido@gmail.com","+5491144754637","45","M",hoy,nacimiento,ingreso))
	conectarse.commit()
	puntero.execute(columnas_mysql, ("Primer Apellido Renzetti", "Primer Nombre" , "Primer Nombre.Primer Apellido.Apellido_2@gmail.com","+5491144754637","13","M",hoy,nacimiento,ingreso))
	conectarse.commit()
	puntero.execute(columnas_mysql, ("Primer Apellido Renzetti", "Segundo Nombre" , "Segundo Nombre.Primer Apellido.Apellido_2@gmail.com","+5491144754637","9","M",hoy,nacimiento,ingreso))
	conectarse.commit()
...
conectarse = mysql.connector.connect(host="localhost",user="root", passwd="utn", database="UTN_practica_2_2019")
puntero = conectarse.cursor()
sql = "SELECT * FROM 2019_Marzo WHERE ALUMNO_MAIL ='ariel.Primer Apellido.Segundo Apellido@gmail.com'"
puntero.execute(sql)
resultados = puntero.fetchall()
for cada_rec in resultados:
	print(cada_rec)
...
conectarse = mysql.connector.connect(host="localhost",user="root", passwd="utn", database="UTN_practica_2_2019")
puntero = conectarse.cursor()
sql = "SELECT * FROM 2019_Marzo WHERE ALUMNO_MAIL LIKE '%Primer Apellido%'"
puntero.execute(sql)
resultados = puntero.fetchall()
for cada_rec in resultados:
	print(cada_rec) 
...
sql = "DELETE FROM 2019_Marzo WHERE ALUMNO_MAIL = 'ariel.Primer Apellido.Segundo Apellido@gmail.com'"
puntero.execute(sql)
print ("borro - "+ str(sql));
conectarse.commit()
...
puntero.execute("SELECT * FROM 2019_Marzo WHERE ALUMNO_MAIL LIKE '%Primer Apellido%'")
resultados = puntero.fetchall()
for cada_rec in resultados:
	print(cada_rec) 

sql = "UPDATE 2019_Marzo SET ALUMNO_MAIL = 'ariel.Primer Apellido.Segundo Apellido@ariel.Primer Apellido.Segundo Apellido@hotmail.com.com' WHERE ALUMNO_MAIL = 'ariel.Primer Apellido.Segundo Apellido@hotmail.com'"
puntero.execute(sql)
conectarse.commit()
